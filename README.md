...
> **Note for graders:** The admin role and dashboards are fully implemented in the codebase, but no admin test account is provided in this submission. To explore admin features, you can manually update a user's `role` field to `ADMIN` in the database via Supabase Studio after registering a test account.
...
| Email | Password | Level | Purpose |
|---|---|---|---|
| `b2univ@test.com` | `12345678` | B2 | University |
...
1. Sign in as `b2univ@test.com` / `12345678`
...
1. Still signed in as `b2univ@test.com`
